...
try {
  ...
  function example_doesOrderMatter() {
    ...
    console.assert(
      evaluate.compareValues(obj1, obj2),
      "obj: same keys/values, different order"
    );
    console.assert(
      evaluate.compareValues(obj1, obj3),
      "obj: same keys/values, same order"
    );
    ...
    arr2[2] = 3;
    console.assert(
      evaluate.compareValues(arr1, arr2),
      "arr: same values, different order"
    );
    console.assert(
      evaluate.compareValues(arr1, arr3),
      "arr: same values, same order"
    );
  }
  ...
  function example_relativeVsAbsolute() {
    ...
    console.assert(
      firstReadFromArray !== secondReadFromArray,
      "first and second array reads should not be the same"
    );
    ...
    console.assert(
      firstReadFromObject === secondReadFromObject,
      "first and second object reads should be the same"
    );
  }

...
try {
  function getterRefactor1() {
    ...
    console.assert(
      obj1Greeting1 === `hi, I'm obj1`,
      `obj1's greeting is correct (1)`
    );

    const obj2Greeting1 = obj2.greeting; // fix this line!
    console.assert(
      obj2Greeting1 === `hi, I'm obj2`,
      `obj2's greeting is correct (1)`
    );
    ...
    console.assert(
      obj1Greeting2 === `hi, I'm first`,
      `obj1's greeting is correct (2)`
    );

    const obj2Greeting2 = obj2.greeting; // fix this line!
    console.assert(
      obj2Greeting2 === `hi, I'm second`,
      `obj2's greeting is correct (2)`
    );
  }
  ...
  function setterRefactor3() {
    ...
    console.assert(obj1.current.second === "bye!", "assert 1"); // write me!
    ...
    console.assert(obj1.current.hasOwnProperty("second") === false, "assert 4"); // write me!
    ...
    console.assert(
      obj1.current.hi.message === 'no entry with key "hi"',
      "assert 7"
    );
    console.assert(obj1.current.hasOwnProperty("first") === false, "assert 8"); // write me!

    obj2.currentEntry = "hi";
    console.assert(
      obj2.current.hi.message === 'no entry with key "hi"',
      "assert 9"
    );
